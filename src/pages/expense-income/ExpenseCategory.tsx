      ...
      <div className="space-y-6">
        <Card>
          <CardHeader className="bg-primary/10 py-3 px-4">
            <CardTitle className="text-base font-semibold text-primary">ADD EXPENSE CATEGORY</CardTitle>
          </CardHeader>
          <CardContent className="pt-6">
            <div className="max-w-lg mx-auto space-y-4">
              <div className="grid grid-cols-[140px_1fr] items-center gap-2">
                <Label className="text-right">Expense Category Name <span className="text-destructive">*</span></Label>
        ...
        <Card>
          <CardHeader className="bg-primary/10 py-3 px-4 flex flex-row items-center justify-between">
            <CardTitle className="text-base font-semibold text-primary">MANAGE EXPENSE CATEGORIES</CardTitle>
            <Input
              placeholder="Search..."
              className="w-48"
              value={search}
