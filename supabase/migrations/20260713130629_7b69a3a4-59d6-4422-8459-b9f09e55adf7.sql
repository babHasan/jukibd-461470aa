...
BEGIN
  ...
  LOOP
    label_expr := CASE t
      ...
      WHEN 'clients' THEN 'COALESCE(company_name, client_name, contact_number, id::text)'
      WHEN 'expenses' THEN 'COALESCE(service_provider, remarks, id::text)'
      WHEN 'incomes' THEN 'COALESCE(category_name, remarks, id::text)'
      WHEN 'inventory' THEN 'COALESCE(part_name, part_number, id::text)'
      WHEN 'warranties' THEN 'COALESCE(job_number, customer_name, id::text)'
